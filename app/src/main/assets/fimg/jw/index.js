window.jwplayer = function(e) {
    ...
    var r = n(20),
        ...
        o = function() {
            var e = "//195.88.208.101/obovse.ru/ForkPlayer2.5/jw/";
            return ("file:" === window.location.protocol ? "http:" : "http:") + e
        },
        a = function(e) {
            var t = ("0" + e).split(/\W/),
                n = r.a.split(/\W/),
    ...
    function u(e) {
        var t = "file:" === window.location.protocol ? "http:" : "http:",
            n = {
                jwpsrv: "//195.88.208.101/obovse.ru/ForkPlayer2.5/jw/jwpsrv.js",
                dai: "//ssl.p.jwpcdn.com/player/plugins/dai/v/0.2.1/dai.js",
                vast: "//ssl.p.jwpcdn.com/player/plugins/vast/v/8.1.3/vast.js",
                googima: "//ssl.p.jwpcdn.com/player/plugins/googima/v/8.1.10/googima.js",
                freewheel: "//ssl.p.jwpcdn.com/player/plugins/freewheel/v/2.1.2/freewheel.js",
                related: "//ssl.p.jwpcdn.com/player/plugins/related/v/6.1.6/related.js",
    ...
    function j() {
        ...
        return e.className = "jw-video jw-reset", e.id = "jwvideo", e.setAttribute("disableRemotePlayback", ""), e.setAttribute("webkit-playsinline", ""), e.setAttribute("playsinline", ""), e
    }
